...
variant, are the experimental results for different optimization tools (in
...
If a figure of merit is not relevant, the value stored is 0.0.
...
the insertion script: <code>php ../scripts/insert.php suite_name.csv</code>
